...
class ClubControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNumMembers('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'club[title]' => 'Something New',
            'club[numMembers]' => 'Something New',
            'club[sport]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNumMembers());
